...
const youtubeApiManager = {
    // 在这里添加您的默认API密钥
    defaultApiKeys: [
        // 在这里填入您的API密钥，格式如下（记得替换成您的实际密钥）:
        // 'AIzaSyXXXXXXXXXXXXXXXXXXXXXX',
        // 'AIzaSyYYYYYYYYYYYYYYYYYYYYYY',
        // 'AIzaSyZZZZZZZZZZZZZZZZZZZZZZ'
        'AIzaSyDZg0s9KIQ8fVDNSiVCpmXf4c_azTZCjfs',
        'AIzaSyA7Cj5vSeUvbDXZySQBkDUZRsB3D5TZDhA',
        'AIzaSyAGbBH4lUTmql7y4UKwZdjO8oJPadgypuE',
        'AIzaSyDzjejdxHOFfv0LNpNCzV2moYSPLuFUDhg',
        'AIzaSyDGpI7nTo4zeBLeKXRq5kcIbEbDWwQxVEg'
        // 'AIzaSyAGbBH4lUTmql7y4UKwZdjO8oJPadgypuE',
        // 'AIzaSyAGbBH4lUTmql7y4UKwZdjO8oJPadgypuE',
        // 'AIzaSyAGbBH4lUTmql7y4UKwZdjO8oJPadgypuE',
        // 'AIzaSyAGbBH4lUTmql7y4UKwZdjO8oJPadgypuE',
    ...
    // 初始化方法，检查localStorage，如果没有则使用默认密钥
    initialize: function() {
        const storedKeys = JSON.parse(localStorage.getItem('youtubeApiKeys')) || [];
        if (storedKeys.length > 0) {
            this.apiKeys = storedKeys;
        } else if (this.defaultApiKeys.length > 0) {
            this.apiKeys = [...this.defaultApiKeys];
